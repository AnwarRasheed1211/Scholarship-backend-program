...
const MacBookAir23 = () => {
  return (
    <div className={styles.macbookAir23}>
      <div className={styles.macbookAir23Child} />
      ...
      <div className={styles.scholarshipWorksWrapper}>
        <div className={styles.scholarshipWorks}>{`Scholarship works  `}</div>
      </div>
      <div className={styles.div}>6215106</div>
      ...
      <div className={styles.rectangleGroup}>
        ...
        <div className={styles.icoutlineMailParent}>
          ...
          />
          <div className={styles.auScholar}>u6215106@au.edu</div>
        </div>
      </div>
      ...
      <div className={styles.appliedWorks}>Applied works</div>
            ...
            <div className={styles.frameGroup}>
              <div className={styles.phclockParent}>
                <image
                  ...
                  src="/phclock.svg"
                />
                <div className={styles.auScholar}>120</div>
              </div>
              <div className={styles.groupParent}>
                ...
                <div className={styles.div3}>25/06/2023</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.anyMechanicalKeyboardEnthusParent}>
            ...
            <div className={styles.frameGroup}>
              ...
              <div className={styles.groupContainer}>
                ...
                <div className={styles.div5}>25/06/2023</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className={styles.frameGroup}>
              ...
              <div className={styles.groupParent1}>
                <div className={styles.rectangleParent2}>
                  ...
                  <b className={styles.accepted}>Rejected</b>
                </div>
                <div className={styles.div7}>25/06/2023</div>
              </div>
            </div>
          </div>
        </div>
